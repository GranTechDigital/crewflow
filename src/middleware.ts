...
const publicApiRoutes = ['/api/auth/login', '/api/auth/register', '/api/periodo/upload', '/api/periodo/dashboard-projetos-simples', '/api/dados/sincronizar-funcoes', '/api/debug/db', '/api/admin/cleanup-remanejamentos']
