...
import { ArrowLeft, Plus, CheckCircle, Clock, AlertTriangle, User, Briefcase } from 'lucide-react';
...
export default function TarefasPage() {
  ...
  const criarTarefa = async () => {
    ...
    if (remanejamento && (remanejamento.statusPrestserv === 'SUBMETIDO' || remanejamento.statusPrestserv === 'APROVADO')) {
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Funcionário: {remanejamento.funcionario.nome}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <h2 className="text-lg font-semibold text-gray-900">{remanejamento.funcionario.nome}</h2>
                <div className="flex items-center space-x-4 text-sm text-gray-600">
                  <span>Matrícula: {remanejamento.funcionario.matricula}</span>
                  <span>Contrato: {remanejamento.funcionario.contrato?.numero || 'N/A'}</span>
                </div>
              </div>
              <div className="text-right">
                <div className="text-sm text-gray-500">Status das Tarefas</div>
                <div className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(remanejamento.statusTarefas)}`}>
          ...
          <div className="p-6">
            {!remanejamento.tarefas || remanejamento.tarefas.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-400 mt-1">Clique em "Nova Tarefa" ou "Tarefas Padrões" para começar</p>
              </div>
            ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          <h4 className="font-medium text-gray-900">{tarefa.tipo}</h4>
