...
export default function TarefasPage() {
  ...
  const [abaAtiva, setAbaAtiva] = useState<"observacoes" | "historico">(
    "observacoes"
  );
  ...
  const criarTarefa = async () => {
    ...
    if (
      ...
      (funcionarioSelecionado.statusPrestserv === "SUBMETIDO" ||
        funcionarioSelecionado.statusPrestserv === "APROVADO")
    ) {
      alert(
  ...
  const buscarObservacoesTarefa = async (
    tarefaId: string,
  ...
  const tarefasFiltradas = tarefas.filter((tarefa) => {
    ...
    const matchTipo =
      !filtroTipo ||
      tarefa.tipo.toLowerCase().includes(filtroTipo.toLowerCase());
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm text-gray-600 mb-3">
                          ...
                          >
                            {editandoDataLimite === tarefa.id ? (
                              <div className="flex items-center space-x-2">
                                ...
                                <button
                                  onClick={() =>
                                    editarDataLimiteTarefa(tarefa.id)
                                  }
                          ...
                          {tarefa.dataConclusao && (
                            <div>
                              Concluída: {formatDate(tarefa.dataConclusao)}
                            </div>
                          )}
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {tarefa.status === "CONCLUIDO" && (
                            <button
                              onClick={() =>
                                atualizarStatusTarefa(tarefa.id, "PENDENTE")
                              }
                ...
                <div className="md:col-span-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNovaTarefa({
                        ...novaTarefa,
                        remanejamentoFuncionarioId: e.target.value,
                      })
                    }
                    className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                  ...
                  {funcionarios.length === 0 && (
                    <p className="text-sm text-gray-500 mt-1">
                      Nenhum funcionário em remanejamento encontrado
                    </p>
                  )}
                </div>
              </div>
              ...
              <>
                ...
                <div>
                  ...
                  {observacoesTarefa[mostrarObservacoesTarefa]?.length > 0 ? (
                    <div className="space-y-3">
                      {observacoesTarefa[mostrarObservacoesTarefa].map(
                        (obs) => (
                          <div
                            key={obs.id}
                            className="border border-gray-200 rounded-lg p-4"
