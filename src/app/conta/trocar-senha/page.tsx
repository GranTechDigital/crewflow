    ...
    try {
      ...
      if (res.ok) {
        ...
        const data = await res
          .json()
          .catch(() => ({ error: "Erro ao trocar senha" }));
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl px-6 py-4 shadow-lg flex items-center gap-3">
            ...
            <span className="text-sm text-gray-800">
              Trocando senha e atualizando seu acesso...
            </span>
          </div>
        </div>
      )}
          ...
          <div className="rounded-2xl bg-white/80 backdrop-blur-sm shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                ...
                <label
                  htmlFor="senha-atual"
                  className="absolute left-4 top-3 text-gray-500 transition-all duration-200 origin-left pointer-events-none peer-placeholder-shown:top-4 peer-placeholder-shown:text-gray-500 peer-focus:top-3 peer-focus:text-red-700 peer-placeholder-shown:scale-100 peer-focus:scale-90"
                >
                  Senha atual
                </label>
              </div>
              ...
              <button
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(to right, #8a0000, #c40000, #ff0000)",
                }}
              >
