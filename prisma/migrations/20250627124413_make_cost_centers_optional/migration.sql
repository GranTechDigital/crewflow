...
CREATE TABLE "new_SolicitacaoRemanejamento" (
    ...
    "centroCustoOrigem" TEXT,
    "contratoDestinoId" INTEGER,
    "centroCustoDestino" TEXT,
    "justificativa" TEXT,
...
INSERT INTO "new_SolicitacaoRemanejamento" ("analisadoPor", "centroCustoDestino", "centroCustoOrigem", "contratoDestinoId", "contratoOrigemId", "createdAt", "dataAnalise", "dataAprovacao", "dataConclusao", "dataSolicitacao", "id", "justificativa", "observacoes", "prioridade", "solicitadoPor", "status", "updatedAt") SELECT "analisadoPor", "centroCustoDestino", "centroCustoOrigem", "contratoDestinoId", "contratoOrigemId", "createdAt", "dataAnalise", "dataAprovacao", "dataConclusao", "dataSolicitacao", "id", "justificativa", "observacoes", "prioridade", "solicitadoPor", "status", "updatedAt" FROM "SolicitacaoRemanejamento";
